...
GBDFile <- "~/Portland/portland-burden-sgy-reformatted.csv" #system.file("gbd_Manuscript_2011-2015.csv", package = "ITHIM")
...
round(100*getAF(ITHIM.baseline, ITHIM.2040.nobuild)$BreastCancer,2)
```
...
for( muwt in muwtVec){
    ITHIM.test <- update(ITHIM.baseline, list(muwt = muwt, muct = 17.82, cv = 1.6475, EXCEL = TRUE))
